...
Public Class frmOtrosDispositivos
    'Generar Enum
    ...
    Private Sub frmOtrosDispositivos_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        txtTipo.DataSource = clsListas.tipoOtros
    End Sub
    ...
    Sub CrearQr()
        ...
        Dim otro As New clsOtrosDispositivos(tipoDispositivo, ubicacion, modelo, etiqueta, emplazamiento, serial)

        txtEtiquetaImprimir.Text = txtEtiqueta.Text

        ImagenQR.Image = generarQR.GenerarBmpQR(gbVistaFinalQR.Width, gbVistaFinalQR.Height, Integer.Parse(txtEscala.Text), otro)
